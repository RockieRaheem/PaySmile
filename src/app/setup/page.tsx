...
import { ArrowLeft, Info, ShoppingCart, ArrowDown, Minus, Plus } from "lucide-react";
...
export default function SetupPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="flex-1 space-y-4 p-4">
          ...
          <CardContent className="flex items-center justify-between p-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <Input
                ...
                className="h-8 w-16 border-0 bg-transparent p-0 text-center text-base font-medium focus-visible:ring-0"
              />
              <Button size="icon" variant="outline" className="h-7 w-7 rounded-full" onClick={() => handleLimitChange(500)}>
        ...
        <Card>
          ...
          <CardContent className="flex flex-col items-center text-center">
            ...
            <ArrowDown className="my-1 text-muted-foreground" />
      ...
      <div className="sticky bottom-0 space-y-2 bg-background p-4">
